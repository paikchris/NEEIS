...
cd /universe/Neeis
export GRAILS_OPTS="-XX:MaxPermSize=1500m -Xmx1500M -server -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/universe/Neeis/logs -javaagent:/universe/Neeis/dripstat/dripstat.jar "
