...
/*
    def saveNewSubmissionv2(data, dataSource_aim, user, uwQuestionsMap, uwQuestionsOrder){
      ...
      //GET UNDERWRITER INFO
      def accountExec = dataMap['accountExec'];
      ...
      //MAKE SURE QUOTE IDS DOESN'T END WITH A COMMA
      ...
      //SEND DATA TO INTELLEDOX FOR INDICATION
