        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 50px 100px; padding-top: 30px;">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                    ...
                    <g:passwordField type="password" class="form-control requiredChangePassword passwordInput" name="currentPassword" placeholder="Current Password" id="currentPassword" />
                ...
                <div class="form-group" style="margin-bottom:25px;">
                    ...
                    <g:passwordField type="password" class="form-control requiredChangePassword passwordInput passwordVerify" name="newPasswordConfirm" placeholder="Confirm New Password" id="newPasswordConfirm" />
                    <span class="help-block"></span>
                </div>
