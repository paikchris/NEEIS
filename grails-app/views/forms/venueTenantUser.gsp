<div id="insuredInfo">
    <div class="col-xs-12">
        ...
        <div class="col-xs-6">
            ...
            %{--ARE YOU THE VENUE OWNER OR TENANT USER Y/N--}%
            <div class="col-xs-12 row">
                <div class="form-group">
                    <label>Are you the venue owner or tenant user?</label><br>
                    <input type="radio" name="venueOwnerTenantUser"
                           class="showReview"
                           value="Venue Owner"
                           data-reviewName="Are you the venue owner or tenant user?"
                           id="venueOwner_RadioButton"> Venue Owner
                    <input type="radio" name="venueOwnerTenantUser"
                           class=""
                           value="Tenant User"
                           data-reviewName="Are you the venue owner or tenant user?"
                           id="tenantUser_RadioButton"
                           checked="checked"> Tenant User
                </div>
            </div>
