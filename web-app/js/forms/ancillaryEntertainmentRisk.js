...
// RENT EQUIPMENT OR VEHICLES TO OTHERS CONTAINER
    $(document.body).on('change', 'input[name="rentEquipmentOrVehiclesToOthers"]',function(){
        if ($(this).attr("value") == "Yes") {
            $("#rentEquipmentOrVehiclesToOthersContainer").css('display', "");
            $("#rentEquipmentOrVehiclesToOthersExplain").css('display', "");
        }
        if ($(this).attr("value") == "No") {
            $("#rentEquipmentOrVehiclesToOthersContainer").css('display', "none");
            $("#rentEquipmentOrVehiclesToOthersExplain").css('display', "none");
        }
    });

// DO YOU DESIGN BUILD AND OR SET UP STAGING AUDIO VISUAL EQUIPMENT TO OTHERS CONTAINER
    $(document.body).on('change', 'input[name="designBuildSetUp"]',function(){
        if ($(this).attr("value") == "Yes") {
            $("#designBuildSetUpContainer").css('display', "");
            $("#designBuildSetUpExplain").css('display', "");
        }
        if ($(this).attr("value") == "No") {
            $("#designBuildSetUpContainer").css('display', "none");
            $("#designBuildSetUpExplain").css('display', "none");
        }
    });
