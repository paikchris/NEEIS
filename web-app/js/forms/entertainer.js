...
// NUMBER OF ENTERTAINERS / CONTAINER
    $(document.body).on('change', '#numberOfEntertainers' ,function(){
        if($.isNumeric($(this).val())){
            ...
            if(parseInt($(this).val()) <=10){
                for(var i =0; i < parseInt($(this).val()); i++){
                    htmlString = "<div class='row'>" +
                        ...
                        "<input type='text' class='form-control  entertainerName' id='entertainer" + i +  "NameInput' data-reviewName='Entertainer Name, Age, Role'" +
                        "name='entertainerName' placeholder='Name'/>" +
                        "</div>" +
                        "</div>" +
                        "<div class='col-xs-2'>" +
                        "<div class='form-group'>" +
                        "<input type='text' class='form-control  entertainerAge' id='entertainer" + i +  "AgeInput' data-reviewName='Entertainer Name, Age, Role'" +
                        "name='entertainerAge' placeholder='Age'/>" +
                        "</div>" +
                        "</div>" +
                        "<div class='col-xs-4'>" +
                        "<div class='form-group'>" +
                        "<input type='text' class='form-control  entertainerRole' id='entertainer" + i +  "RoleInput' data-reviewName='Entertainer Name, Age, Role'" +
                        "name='entertainerRole' placeholder='Role'/>" +
                        "</div>" +
                        "</div>" +
                        "</div>";
                ...
                alert("Please enter only up to 10 entertainers.")
                $(this).val("10");
                for(var i =0; i < 10; i++){
                    htmlString = "<div class='row'>" +
                        "<div class='col-xs-6'>" +
            ...
            $('#entertainerDetailContainer').html(finalString);
        }
        else{
            $(this).val("");
        }
...
// PROJECTS OUTSIDE THE US CONTAINER
    $(document.body).on('change', 'input[name="projectsOutsideUS"]', function () {
        //alert();
        if ($(this).attr("value") == "Yes") {
            $("#projectsOutsideUSContainer").css('display', "");
            $("#projectsOutsideUSExplain").css('display', "");
        }
        if ($(this).attr("value") == "No") {
            $("#projectsOutsideUSContainer").css('display', "none");
            $("#projectsOutsideUSExplain").css('display', "none");
        }
    });

// PROVIDE TOUR ITINERARY CONTAINER
    $(document.body).on('change', 'input[name="touringEntertainer"]', function () {
        //alert();
        if ($(this).attr("value") == "Yes") {
            $("#tourItineraryContainer").css('display', "");
            $("#tourItineraryExplain").css('display', "");
        }
        if ($(this).attr("value") == "No") {
            $("#tourItineraryContainer").css('display', "none");
            $("#tourItineraryExplain").css('display', "none");
        }
    });
