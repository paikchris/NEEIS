...
function buildTestProductConditionsJSON(){
    var testConditions = {}


    //FIRST LEVEL IS CONDITIONS
    testConditions.EPKG = {}
    testConditions.CGL = {}

    //SECOND LEVEL IS PRODUCTS
    var mapEPKG = {
        'PIP CHOICE': 'always',
        'PIP 1': 'always',
        'PIP 2': 'always'
    }
    testConditions.EPKG = mapEPKG
...
//TAKES RISK TYPE AND PREMIUM PREREQ'S AND RETURNS AVAILABLE PRODUCTS
