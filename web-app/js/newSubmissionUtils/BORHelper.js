...
function checkNamedInsured(){
    ...
    if (checkName.length > 1 && (zipCodeMailing.length == 5)) {
        addLoadingSpinnerToInput_right($('#namedInsured'), 'VERIFYING')
        $.ajax({
            method: "POST",
            ...
            .done(function(msg) {
                removeLoadingSpinnerFromInput($('#namedInsured'))
...
function clearRenewalAndBORFromSubmission(){
    ...
    removeGlyphFromInput($("#namedInsured"))
...
function markNamedInsuredInputAsError(){
    ...
    addGlyphToInput_right($("#namedInsured"), 'remove')
}
...
function markNamedInsuredInputAsOK(){
    ...
    addGlyphToInput_right($("#namedInsured"), 'ok')
...
function markNamedInsuredInputAsBOR(){
    ...
    addGlyphToInput_right($("#namedInsured"), 'list-alt')
