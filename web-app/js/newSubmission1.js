            ...
            if (e.target.id == "nextButtonStep1" ) {
                ...
                if ($("li.active").length > 0) {
                    ...
                    if(riskChosen === "Specific Film Projects Test"){
                        ...
                        $("#insuredInfoInsert").load("./../forms/specFilmNew #insuredInfo", function () {
                            finishedLoading1 = true;
                            if(finishedLoading1 && finishedLoading2 && finishedLoading3){
                                $('#loadingModal').hide();
                            }
                        });
                        $("#coverageCheckboxesDiv").load("./../forms/specFilmNew #coverageCheckboxesDiv", function () {
                            finishedLoading3 = true;
                            if(finishedLoading1 && finishedLoading2 && finishedLoading3){
                                $('#loadingModal').hide();
                            }
                        });
                        $("#riskSpecificInsert").load("./../forms/specFilmNew #riskSpecificInfo", function () {
